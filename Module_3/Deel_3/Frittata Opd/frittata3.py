...
print(f"{str_amount_fraction(melk)} {str_single_plural(melk, TXT_CUPS)} {TXT_MILK} ({unit2ml(melk , ML_CUP)} ml )")
print(f"{str_amount_fraction(zout)} {str_single_plural(zout, TXT_TEASPOONS)} {TXT_SALT}  ({ml2gram(unit2ml(zout , ML_TEASPOON),GRAM_PER_ML_SALT)} gram) ")
print(f"{str_amount_fraction(peper)} {str_single_plural(peper , TXT_TEASPOONS)} {TXT_PEPPER}({ml2gram(unit2ml(peper , ML_TEASPOON),GRAM_PER_ML_PEPPER)} gram)")
...
print(f"{str_amount_fraction(spinazie)} {str_single_plural(spinazie , TXT_CUPS)} {TXT_SPINACH} ({ml2gram(unit2ml(spinazie , ML_CUP),GRAM_PER_ML_SPINACH)} gram)")
print(f"{str_amount_fraction(kaas)} {str_single_plural(kaas , TXT_CUPS)} {TXT_CHEESE} ({ml2gram(unit2ml(kaas, ML_CUP),GRAM_PER_ML_CHEESE)} gram)")
print('-----------------------------------------------')