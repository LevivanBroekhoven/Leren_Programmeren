...
totale_kostenE = totale_kostenC / 100



print("Dit geweldige dagje-uit met" ,aantal_mensen,"mensen in de Speelhal met",aantal_minuten_VR,"minuten VR kost je maar",round(totale_kostenE,2),"euro totaal")